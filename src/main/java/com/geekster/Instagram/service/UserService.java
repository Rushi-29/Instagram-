...
public class UserService {
    ...
    public void updateUser(SignUpInput signUpInput) {
        ...
        //save the user
        User user = new User(user1.getId(),signUpInput.getFirstName(),signUpInput.getLastName(),signUpInput.getAge(),signUpInput.getEmail(),encryptedPassword,signUpInput.getContact());
